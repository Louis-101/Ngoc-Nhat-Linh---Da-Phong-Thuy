  ...
  return (
    <div className="pt-24 pb-20 bg-white bg-pattern-subtle min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Content */}
        <div className="prose prose-lg md:prose-xl max-w-none prose-headings:font-serif prose-headings:font-bold prose-headings:text-[#4d241e] prose-p:text-gray-700 prose-p:leading-relaxed prose-strong:text-[#4d241e] prose-strong:font-bold prose-img:rounded-3xl prose-a:text-primary">
